...
import com.auction.Exceptions.SellerExceptionHandler;
import com.auction.models.Seller;
import com.auction.repository.SellerRepo;
...
public class SellerController {
	...
	public ResponseEntity<Seller> getSellerById(@PathVariable Integer sellerID) {
		Seller seller = sellerRepo.findById(sellerID).orElseThrow(()-> new SellerExceptionHandler("Seller not exist with id:"+sellerID));
	...
	//get product by id 
		...
		public ResponseEntity<Seller> getProductById(@PathVariable Integer sellerID) {
			Seller seller = sellerRepo.findById(sellerID).orElseThrow(()-> new SellerExceptionHandler("Product not exist with id:"+sellerID));
			return ResponseEntity.ok(seller);
		}
